...
typedef struct _SetupHelper_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } SetupHelper_MIDL_TYPE_FORMAT_STRING;

typedef struct _SetupHelper_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } SetupHelper_MIDL_PROC_FORMAT_STRING;

typedef struct _SetupHelper_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } SetupHelper_MIDL_EXPR_FORMAT_STRING;
...
extern const SetupHelper_MIDL_TYPE_FORMAT_STRING SetupHelper__MIDL_TypeFormatString;
extern const SetupHelper_MIDL_PROC_FORMAT_STRING SetupHelper__MIDL_ProcFormatString;
extern const SetupHelper_MIDL_EXPR_FORMAT_STRING SetupHelper__MIDL_ExprFormatString;


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO IShareFun_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IShareFun_ProxyInfo;
...
static const SetupHelper_MIDL_PROC_FORMAT_STRING SetupHelper__MIDL_ProcFormatString =
    {
        0,
        {
...
/* 64 */	NdrFcShort( 0x49a ),	/* Type Offset=1178 */
...
static const SetupHelper_MIDL_TYPE_FORMAT_STRING SetupHelper__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* Object interface: IShareFun, ver. 0.0,
   GUID={0x341a0f93,0xdc36,0x42fb,{0x93,0xdc,0xda,0x97,0xac,0x84,0xf4,0x5f}} */

#pragma code_seg(".orpc")
static const unsigned short IShareFun_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO IShareFun_ProxyInfo =
    {
    &Object_StubDesc,
    SetupHelper__MIDL_ProcFormatString.Format,
    &IShareFun_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IShareFun_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    SetupHelper__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(9) _IShareFunProxyVtbl = 
{
    &IShareFun_ProxyInfo,
    &IID_IShareFun,
    ...
    (void *) (INT_PTR) -1 /* IShareFun::GetSystemPath */ ,
    (void *) (INT_PTR) -1 /* IShareFun::GetProgramFilesPath */
};


static const PRPC_STUB_FUNCTION IShareFun_table[] =
{
...
CInterfaceStubVtbl _IShareFunStubVtbl =
{
    &IID_IShareFun,
    &IShareFun_ServerInfo,
    9,
    &IShareFun_table[-3],
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    SetupHelper__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _SetupHelper_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IShareFunProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _SetupHelper_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IShareFunStubVtbl,
    0
};

PCInterfaceName const _SetupHelper_InterfaceNamesList[] = 
{
    "IShareFun",
    0
};

const IID *  const _SetupHelper_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _SetupHelper_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _SetupHelper, pIID, n)

int __stdcall _SetupHelper_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_SetupHelper_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo SetupHelper_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _SetupHelper_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _SetupHelper_StubVtblList,
    (const PCInterfaceName * ) & _SetupHelper_InterfaceNamesList,
    (const IID ** ) & _SetupHelper_BaseIIDList,
    & _SetupHelper_IID_Lookup, 
    1,
    2,
