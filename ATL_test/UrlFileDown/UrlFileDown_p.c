...
typedef struct _UrlFileDown_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } UrlFileDown_MIDL_TYPE_FORMAT_STRING;

typedef struct _UrlFileDown_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } UrlFileDown_MIDL_PROC_FORMAT_STRING;

typedef struct _UrlFileDown_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } UrlFileDown_MIDL_EXPR_FORMAT_STRING;
...
extern const UrlFileDown_MIDL_TYPE_FORMAT_STRING UrlFileDown__MIDL_TypeFormatString;
extern const UrlFileDown_MIDL_PROC_FORMAT_STRING UrlFileDown__MIDL_ProcFormatString;
extern const UrlFileDown_MIDL_EXPR_FORMAT_STRING UrlFileDown__MIDL_ExprFormatString;


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO IHttpDown_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IHttpDown_ProxyInfo;
...
static const UrlFileDown_MIDL_PROC_FORMAT_STRING UrlFileDown__MIDL_ProcFormatString =
    {
        0,
        {

	/* Procedure GetDownloadFile */
...
/* 34 */	NdrFcShort( 0x496 ),	/* Type Offset=1174 */

	/* Parameter pVal */

/* 36 */	NdrFcShort( 0x2150 ),	/* Flags:  out, base type, simple ref, srv alloc size=8 */
/* 38 */	NdrFcShort( 0x24 ),	/* x86 Stack size/offset = 36 */
/* 40 */	0x6,		/* FC_SHORT */
			0x0,		/* 0 */
...
static const UrlFileDown_MIDL_TYPE_FORMAT_STRING UrlFileDown__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* Object interface: IHttpDown, ver. 0.0,
   GUID={0xe3bd8ea0,0x363c,0x48e4,{0xbc,0xcc,0x60,0xdc,0xe3,0x00,0xa5,0x5a}} */

#pragma code_seg(".orpc")
static const unsigned short IHttpDown_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO IHttpDown_ProxyInfo =
    {
    &Object_StubDesc,
    UrlFileDown__MIDL_ProcFormatString.Format,
    &IHttpDown_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IHttpDown_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    UrlFileDown__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(8) _IHttpDownProxyVtbl = 
{
    &IHttpDown_ProxyInfo,
    &IID_IHttpDown,
    ...
    (void *) (INT_PTR) -1 /* IHttpDown::GetDownloadFile */
};


static const PRPC_STUB_FUNCTION IHttpDown_table[] =
{
...
CInterfaceStubVtbl _IHttpDownStubVtbl =
{
    &IID_IHttpDown,
    &IHttpDown_ServerInfo,
    8,
    &IHttpDown_table[-3],
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    UrlFileDown__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _UrlFileDown_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IHttpDownProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _UrlFileDown_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IHttpDownStubVtbl,
    0
};

PCInterfaceName const _UrlFileDown_InterfaceNamesList[] = 
{
    "IHttpDown",
    0
};

const IID *  const _UrlFileDown_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _UrlFileDown_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _UrlFileDown, pIID, n)

int __stdcall _UrlFileDown_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_UrlFileDown_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo UrlFileDown_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _UrlFileDown_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _UrlFileDown_StubVtblList,
    (const PCInterfaceName * ) & _UrlFileDown_InterfaceNamesList,
    (const IID ** ) & _UrlFileDown_BaseIIDList,
    & _UrlFileDown_IID_Lookup, 
    1,
    2,
